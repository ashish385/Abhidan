...
const RegSelection = () => {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row bg-richblack-800 p-1 gap-x-1 my-6 justify-around rounded-md md:rounded-full w-full md:max-w-max">
        <button
      ...
      <div>
        {accountType === "donar" ? (
          ...
          <NgoRegistation setAccountType={setAccountType} />
        )}
      </div>
    </>
  );
